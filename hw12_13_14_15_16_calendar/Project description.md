...
У меня установлена более новая версия линтера. К сожалению, у неё кардинально другой конфиг, также отличается набор команд (какие-то переехали в конфиг). Проверить эту секцию, не сломав своего окружения, я не могу.
