...
import (
	...
	storagesql "github.com/Averlex/golang-hw/hw12_13_14_15_16_calendar/internal/storage/sql"
)
...
func (_m *DB) BeginTxx(ctx context.Context, opts *sql.TxOptions) (storagesql.Tx, error) {
	...
	var r0 storagesql.Tx
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *sql.TxOptions) (storagesql.Tx, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *sql.TxOptions) storagesql.Tx); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(storagesql.Tx)
		}
	}
