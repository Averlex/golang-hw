...
func (_m *Tx) PrepareNamed(query string) (*sqlx.NamedStmt, error) {
	ret := _m.Called(query)
...
// Tx_PrepareNamed_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PrepareNamed'
type Tx_PrepareNamed_Call struct {
	*mock.Call
}

// PrepareNamed is a helper method to define mock.On call
//   - query string
func (_e *Tx_Expecter) PrepareNamed(query interface{}) *Tx_PrepareNamed_Call {
	return &Tx_PrepareNamed_Call{Call: _e.mock.On("PrepareNamed", query)}
}

func (_c *Tx_PrepareNamed_Call) Run(run func(query string)) *Tx_PrepareNamed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *Tx_PrepareNamed_Call) Return(_a0 *sqlx.NamedStmt, _a1 error) *Tx_PrepareNamed_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Tx_PrepareNamed_Call) RunAndReturn(run func(string) (*sqlx.NamedStmt, error)) *Tx_PrepareNamed_Call {
	_c.Call.Return(run)
	return _c
}
